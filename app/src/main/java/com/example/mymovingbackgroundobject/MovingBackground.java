...
public class MovingBackground extends View
{
    ...
    private void init(@Nullable AttributeSet set)
    {
        ...
        String strBlendMode = typedArray.getString(R.styleable.MovingBackground_blendMode);
        this.blendMode = PorterDuff.Mode.valueOf((strBlendMode == null || strBlendMode.equals("") ? "CLEAR" : strBlendMode));
        ...
        {
            this.imageSources[i] = new ImageSource(i, getResources(), this.image_source_id, this.blendMode);
